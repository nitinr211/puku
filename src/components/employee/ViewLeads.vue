  ...
  <v-app>
    ...
    <div>
      ...
      <v-content>
              ...
              <div class="message-box" v-chat-scroll>
                <v-list dense class="pukulist">
                  <v-list-tile v-for="leadrecord in leadrecords" :key="leadrecord.id">
                    ...
                    <a style="color:red;margin-left:10px" v-if="leadrecord.seenCounselor == false" onclick="style.display = 'none'"> 
                    
                      <v-btn dark color="green" @click="changeSeen(leadrecord.id)">
       ...
       <v-btn :to="{name: 'EmployeeAddFile', params:{id:this.$route.params.id}}" 
          fab
          large
          bottom
          right
